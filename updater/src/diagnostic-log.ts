...
class StreamingRedactor {
  ...
  private drain(final: boolean): string {
    ...
    while (this.pending.length > 0) {
      ...
      const assignment = /(?:^|[^a-z0-9_-])(?:"[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*"|'[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*'|[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*)\s*[:=]\s*(["']?)/i
        .exec(this.pending);
      ...
      if (lastBoundary >= 0) {
        ...
        const partialAssignment = /(?:^|[^a-z0-9_-])(?:"[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*"|'[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*'|[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*)\s*$/i.exec(safe);
      ...
      const sensitive = /(?:\b(?:xapp|xox[abp])[-_]|\b(?:ghp|github_pat)_|(?:^|[^a-z0-9_-])(?:"[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*"|'[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*'|[a-z0-9_-]*(?:authorization|auth[-_]?token|_auth|api[-_]?key|token|secret|password)[a-z0-9_-]*)\s*[:=]|https?:\/\/|\/(?:Users|home|private|var\/folders|tmp)\/)/i.exec(this.pending);
