...
describe("DispatcherDatabase", () => {
  test("transactionally migrates a real schema v2 fixture to v3 without losing job state", async () => {
    ...
    for (const name of ["jobs_event_idx", "jobs_thread_idx", "jobs_run_idx", "jobs_runnable_fair_idx", "jobs_workspace_job_idx", "jobs_status_job_idx", "jobs_nonterminal_job_idx"]) {
