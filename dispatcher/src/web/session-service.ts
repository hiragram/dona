...
/** Fixed session protocol exposure. Runtime must establish protected providers
 * and readiness before start(); importing this module starts no listener. */
export class WebSessionService extends WebInternalService {
  constructor(socketPath: string, scope: ServiceScope, repository: WebAuthRepository,
    ...
    super(socketPath, scope, repository, credentials, now, deadlineMs, "session");
  }
}
