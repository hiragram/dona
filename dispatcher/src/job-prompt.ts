  ...
  const jobJson = JSON.stringify({
    ...
    ...(runtimeIdentity&&workerMessagingSocketPath&&row.source!=="dona_schedule"?{worker_messaging:{
      ...
      report:{method:"POST",path:`/v1/jobs/${row.job_id}/messages/reports`,content_type:"application/json",
        ...
        payload_variants:{checkpoint:{summary:"1..4000 chars",eta_at:"optional UTC RFC 3339"},question:{question:"1..4000 chars"},
          risk:{summary:"1..4000 chars",severity:["low","medium","high"],eta_at:"optional UTC RFC 3339"},
